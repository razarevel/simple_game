...
Entities::Entities(MAI::Renderer *ren, VkFormat format) : ren_(ren) {
...
void Entities::drawModels(MAI::CommandBuffer *buffer, glm::mat4 proj,
...
std::vector<ModelInfo> Entities::getModelInfos() {
...
void Entities::preparePipeline(VkFormat format) {
